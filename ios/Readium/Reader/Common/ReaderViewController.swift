...
class ReaderViewController: UIViewController, Loggable {
  ...
  override func viewDidLoad() {
    ...
    updateStatusBar(animated: false)
  ...
  func toggleStatusBar() {
    ...
    delegate?.onFullScreen(hidden: statusBarHidden)
  }

  func updateStatusBar(animated: Bool = true) {
  ...
  override var prefersStatusBarHidden: Bool {
    return statusBarHidden && !UIAccessibility.isVoiceOverRunning
  }
